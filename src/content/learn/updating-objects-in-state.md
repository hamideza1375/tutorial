...
توجه داشته باشید که "..." نحو گسترش "کم عمق" است -- این فقط چیزها را در عمق یک سطح کپی می کند. این باعث می‌شود که سریع باشد، اما همچنین به این معنی است که اگر می‌خواهید یک ویژگی تودرتو را به‌روزرسانی کنید، باید بیش از یک بار از آن استفاده کنید.
